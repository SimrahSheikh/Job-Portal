...
const Login = () => {
  ...
  return (
    <>
      ...
      <section className="flex items-center justify-center min-h-screen bg-w">
        <div className="w-full max-w-md p-8 bg-white rounded-2xl shadow-lg">
          ...
          <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
            ...
            <button
              ...
              className="w-full py-3 text-white bg-blue-500 hover:bg-blue-600 rounded-lg font-semibold transition-all"
            >
              Log In
            </button>
...
const Login = () => {
  ...
  return (
    <section className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-100 to-blue-300">
      <div className="w-full max-w-md p-8 bg-white rounded-2xl shadow-lg">
        <h2 className="text-center text-2xl font-bold text-blue-600">Login to your account</h2>
...
export default Login;
>>>>>>> 52880d006904a65c57157216069bf4bf022433ea:src/components/auth/Login.jsx
