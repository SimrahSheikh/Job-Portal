                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-blue-50 rounded-lg shadow-lg overflow-hidden transition-transform duration-300 hover:scale-105">
                        <div className="p-8">
                            ...
                            <button className="w-full mt-8 px-6 py-3 bg-blue-600 text-white font-medium rounded-md hover:bg-blue-700">
                                Choose Premium
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="bg-purple-50 rounded-lg shadow-lg overflow-hidden transition-transform duration-300 hover:scale-105">
                        <div className="p-8">
                            ...
                            <button className="w-full mt-8 px-6 py-3 bg-purple-600 text-white font-medium rounded-md hover:bg-purple-700">
                                Choose Premium+
                            </button>
                        </div>
                    </div>
